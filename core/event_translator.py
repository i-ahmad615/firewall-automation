...
_MODULE_CATEGORY = {
    "core.email_client": "Email",
    "core.email_monitor": "Alert Processing",
    "core.firewall_client": "Firewall API",
    "core.firewall_monitor": "Firewall Connectivity",
    "core.rule_updater": "Firewall Rule",
    "core.xml_handler": "Firewall Rule",
...
def translate(*, level_name: str, module_name: str, raw_message: str) -> TranslatedEvent:
    severity = level_name.upper()
    success = severity not in ("ERROR", "CRITICAL")
    return TranslatedEvent(
        severity=severity,
        category=category_for_module(module_name),
